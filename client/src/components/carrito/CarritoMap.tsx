    ...
    <section id="productos" className="flex flex-col gap-5 justify-center">
      ...
      <section className="bg-neutral-200 rounded-xl p-3 mx-3 min-h-20">
        ...
        <div className="flex items-center justify-between">
          ...
          <h2 className="font-bold text-xl bg-neutral-100 p-0.5 rounded-xl">
            {carrito?.total?.toFixed(2)} USD
          </h2>
        </div>
      </section>
      <MetodoPago />
      <div className="font-bold text-sm flex items-center bg-neutral-200 rounded-xl p-3 mx-3">
        <img className="size-10" src="/svg/clock.svg" alt="Entregas Puntual" />
